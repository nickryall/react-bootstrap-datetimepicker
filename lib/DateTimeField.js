...
var DateTimeField = (function (_Component) {
  ...
  function DateTimeField() {
    ...
    this.state = {
      ...
      buttonIcon: this.props.mode === _ConstantsJs2["default"].MODE_TIME ? "fa fa-clock" : "fa fa-calendar",
      widgetStyle: {
        display: "block",
        position: "absolute",
        left: -9999,
    ...
    value: function render() {
      return _react2["default"].createElement(
        ...
        _react2["default"].createElement(
          ...
          _react2["default"].createElement("input", _extends({ className: `form-control ${ this.props.disabled ? 'disabled' : '' }`, onChange: this.onChange, type: "text", value: this.state.inputValue }, this.props.inputProps)),
          _react2["default"].createElement(
            "span",
