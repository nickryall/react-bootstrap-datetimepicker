  ...
  render() {
    ...
    <div className="datepicker-days" style={{display: "block"}}>
        <table className="table-condensed">
          <thead>
            <tr>
              <th className="prev" onClick={this.props.subtractMonth}><span className="fa fa-chevron-left" /></th>
              ...
              <th className="next" onClick={this.props.addMonth}><span className="fa fa-chevron-right" /></th>
            </tr>
